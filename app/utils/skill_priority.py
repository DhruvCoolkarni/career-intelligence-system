...
def calculate_skill_priorities(
    ...
    for skill in missing_skills:
        ...
        is_core_skill = normalized_skill in importance_lookup
        is_technical_skill = normalized_skill in software_lookup


        if is_core_skill:

            importance = importance_lookup[normalized_skill]
